...
function updateDevices() {
      const livingRoomRef = firebase.database().ref("Bedroom");
...
function listenToDeviceChanges() {
      const deviceRef = firebase.database().ref("Bedroom");
...
function syncToThingSpeak() {
    const firebaseRef = firebase.database().ref("Bedroom");
